...
class StudyRoomTapFavorRecyclerAdapter(val context:Context, val documents:List<StudyRoom>) : Adapter<StudyRoomTapFavorRecyclerAdapter.VH>(){
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        if(studyRoom.distance=="") holder.binding.tvDistance.text="찜목록"
